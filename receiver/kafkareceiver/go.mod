...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/azure v0.149.0
	...
	go.opentelemetry.io/collector/consumer/xconsumer v0.149.1-0.20260402195938-76ede073ee8e
