...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.149.0
	...
	go.opentelemetry.io/collector/scraper/scrapertest v0.149.1-0.20260402195938-76ede073ee8e
