	...
	tests := map[string]struct {
		...
		`metrics_pod_level_hints_only`: {
			...
			expectedReceiver: receiverTemplate{
				...
				}, signals: receiverSignals{metrics: true, logs: false, traces: false, profiles: false},
			},
			wantError:       false,
			ignoreReceivers: []string{},
	...
	tests := map[string]struct {
		...
		`logs_pod_level_hints_only`: {
			...
			expectedReceiver: receiverTemplate{
				...
				}, signals: receiverSignals{metrics: false, logs: true, traces: false, profiles: false},
			},
			wantError:       false,
			ignoreReceivers: []string{},
