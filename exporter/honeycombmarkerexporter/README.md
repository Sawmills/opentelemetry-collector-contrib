...
This exporter allows creating [markers](https://docs.honeycomb.io/configure/environments/manage-markers/), via the [Honeycomb Markers API](https://api-docs.honeycomb.io/api/markers/getmarker), based on the look of incoming telemetry.
