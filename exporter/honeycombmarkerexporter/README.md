...
This exporter allows creating [markers](https://docs.honeycomb.io/configure/environments/manage-markers/), via the [Honeycomb Markers API](https://api-docs.honeycomb.io/api/markers/createmarker), based on incoming telemetry.
