...
This exporter allows creating [markers](https://docs.honeycomb.io/configure/environments/manage-markers/), via the [Honeycomb Markers API](https://docs.honeycomb.io/api/markers/create-a-marker), based on the look of incoming telemetry. 
