...
require (
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/grpcutil v0.149.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/otelarrow v0.149.0
	...
	go.opentelemetry.io/collector/config/configauth v1.55.1-0.20260402195938-76ede073ee8e
