...
- `api_version` is the API version of [Alertmanager](https://prometheus.io/docs/alerting/latest/alertmanager/). By default the value is set to "v2" and can be overridden to "v1" if using an older version of Alertmanager.
