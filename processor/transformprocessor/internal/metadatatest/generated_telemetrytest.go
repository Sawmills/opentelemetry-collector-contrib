...
func NewSettings(tt *componenttest.Telemetry) processor.Settings {
	...
	set.ID = component.NewID(component.MustNewType("transform"))
	set.TelemetrySettings = tt.NewTelemetrySettings()
	return set
}

func AssertEqualProcessorTransformLogsFailed(t *testing.T, tt *componenttest.Telemetry, dps []metricdata.DataPoint[int64], opts ...metricdatatest.Option) {
	want := metricdata.Metrics{
		Name:        "otelcol_processor_transform_logs_failed",
		Description: "Number of logs that failed to be transformed by the transform processor",
		Unit:        "1",
	...
	got, err := tt.GetMetric("otelcol_processor_transform_logs_failed")
