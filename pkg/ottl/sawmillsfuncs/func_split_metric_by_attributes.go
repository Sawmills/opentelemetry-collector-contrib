...
func (t *generatedMetricTracker) mark(iteration *ottlmetric.MetricIteration, metricIndex int) {
	t.markWithCleanup(iteration, metricIndex, true)
}

func (t *generatedMetricTracker) markWithoutCleanup(iteration *ottlmetric.MetricIteration, metricIndex int) {
	t.markWithCleanup(iteration, metricIndex, false)
}

func (t *generatedMetricTracker) markWithCleanup(iteration *ottlmetric.MetricIteration, metricIndex int, cleanup bool) {
...
func splitMetricByAttributes[K any](
	...
	legacyIteration := ottlmetric.NewMetricIteration()
		...
		case pmetric.MetricTypeGauge:
			...
			if newDataPoints.Len() > 0 {
				...
				if hasMetricIteration {
					...
					generatedMetrics.markWithoutCleanup(iteration, metrics.Len()-1)
				}
