...
"""Analyze queue-drain local red/green proof artifacts."""
...
BACKEND_ACCEPTED = "queuedrain_backend_log_records_total"
BACKEND_RECEIVED = "queuedrain_backend_received_log_records_total"
BACKEND_FAILED = "queuedrain_backend_failures"
TALLY_ACCEPTED = "queuedrain_tally_accepted_log_records"
TALLY_RECEIVED = "queuedrain_tally_received_log_records"
TALLY_FAILED = "queuedrain_tally_failed_log_records"
...
def write_outputs(directory: Path, summary: dict[str, object]) -> None:
    ...
    lines = [
        f"# queue-drain {summary['expect']} proof",
        "",
